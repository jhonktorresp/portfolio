...
class Portfolio extends Component {
	...
	makeOneThumb(source,nowProject,pointer){
		...
		return <div className='col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 pb-3'><img alt='' width='100%' height='100%' src={this.getMedia(source)} className={'pr-1 pl-1 pt-2 pb-2 '+cls} key={source} onClick={() => this.props.handler(pointer)} /></div>
